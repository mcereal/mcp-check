  ...
  constructor(
    ...
    const redactionConfig = {
      ...
      allowedFields: config.redaction?.allowedFields ?? [
        ...
        'skipped',
        'warnings',
        // Structural keys — must be preserved so reporters can traverse the results
        // tree. Without these, redactRecursive() replaces arrays/objects with
        // "[REDACTED]" strings, causing .map() crashes in reporters.
        'suites',
        'cases',
        'fixtures',
        'metadata',
